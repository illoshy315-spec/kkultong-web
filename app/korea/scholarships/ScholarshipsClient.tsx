    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mb-10">
        ...
        <p className="text-base" style={{ color: "var(--gray)", opacity: 0.65 }}>
          {(scholarships as Scholarship[]).length} programs verified as of{" "}
          {(scholarships as Scholarship[])[0]?.last_verified ?? "2025"}.
        ...
        {filtered.map((s) => {
          ...
          return (
            <div
              ...
              style={{ borderColor: isOpen ? "var(--teal)" : "#e5e7eb" }}
            >
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      ...
                      {s.visa_types.map((v) => (
                        <span
                          ...
                          style={{ backgroundColor: "#f3f4f6", color: "var(--gray)" }}
                        >
                          {v}
                        </span>
                      ))}
                    </div>
                    <p className="font-bold text-sm leading-snug" style={{ color: "var(--gray)" }}>
                      {s.name_en}
                    </p>
                    <p className="text-xs mt-0.5" style={{ color: "var(--gray)", opacity: 0.5 }}>
                      {s.name_ko} · {s.provider}
                    </p>
                  </div>
                  <span
              ...
              {isOpen && (
                ...
                >
                  <div className="grid gap-4 mt-4">
                    <Row label="Amount" value={s.amount} />
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <p className="text-xs" style={{ color: "var(--gray)", opacity: 0.4 }}>
      ...
      <div className="mt-12 rounded-2xl p-5 border" style={{ borderColor: "#e5e7eb", backgroundColor: "#f9fafb" }}>
        <p className="text-xs font-bold mb-2" style={{ color: "var(--gray)" }}>
        ...
        <p className="text-xs leading-relaxed" style={{ color: "var(--gray)", opacity: 0.65 }}>
          ...
          This page is a starting point — always confirm current details via the official links above
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div>
      <p className="text-xs font-bold uppercase tracking-wide mb-1" style={{ color: "var(--gray)", opacity: 0.4 }}>
        {label}
      </p>
