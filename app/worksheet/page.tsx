...
const worksheets: WorksheetEntry[] = [
  ...
  { day: null, slug: "supplement_layers", label: "Reference", title: "한국어 단어의 세 층위", subtitle: "Where Korean Words Come From", description: "Native Korean, Sino-Korean, and loanwords. Understanding which is which unlocks vocabulary patterns, nuance, and spelling rules — before you dive into Series 2.", available: true },
  ...
  { day: null, slug: "supplement_saisiot", label: "Reference", title: "사이시옷 심화", subtitle: "사이시옷 — The Spelling Rule Sound Made", description: "Why does 비 + 소리 become 빗소리, not 비소리? The sound change that triggers it, the spelling rule that marks it, and the six Sino-Korean exceptions even native speakers get wrong.", available: true },
