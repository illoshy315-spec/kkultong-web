...
seo_description: "Why does Korean split English 'at' into two particles? What does (으)로 replace — by, with, toward, made of? Learn all remaining Korean particles with English comparisons. Free worksheet."
type: worksheet
...
One English "at" splits into two Korean particles.
The verb tells you which to use — state verb → 에, action verb → 에서.
...
In K-dramas and everyday conversation, **하고** is by far the most common.
In news, textbooks, and formal writing, **와/과** is used.
...
Choose from the box and fill in the blank.
*(하고 / 도 / 만 / 한테 / 한테서 / 부터 / 까지)*
