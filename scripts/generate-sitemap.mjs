...
// NOTE: /korea/* sitemap generation (tips, scholarships, places, routes) is
// intentionally removed while app/korea is offline (moved to _offline/,
// see CLAUDE.md). Restore alongside app/korea when it's brought back live.
